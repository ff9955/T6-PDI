...
srun --hint=nomultithread --distribution=block:block cp2k.psmp CRYS_PAIRS_interface-dimer-1.txt_DZVP-GTH_PBE-GTH.inp > CRYS_PAIRS_interface-dimer-1.txt_DZVP-GTH_PBE-GTH.out
