...
srun --hint=nomultithread --distribution=block:block cp2k.psmp CRYS_PAIRS_crystal-284-306.xyz_DZVP-GTH_PBE-GTH.inp > CRYS_PAIRS_crystal-284-306.xyz_DZVP-GTH_PBE-GTH.out
