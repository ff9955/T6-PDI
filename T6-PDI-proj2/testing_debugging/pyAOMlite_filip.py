...
dimer_dir='/scratch/fivanovic/X-SH/T6-PDI-proj2/testing_debugging/2phase_recomb_checks/xsh_vs_pyAOM/interface_dimer_geoms_100fs/'

# define the AOM files for both dimer fragments
frag1_AOM_file='output/6T/AOM_HOMO_COEFF.dat'
frag2_AOM_file='output/PDI/AOM_LUMO_COEFF.dat'
# define MOs
frag1_MO=73
frag2_MO=71
#--------------------------------------------------------------------------------
name = [f'interface-dimer-{q}.txt' for q in range(0,10)]
...
#np.savetxt('T6-PDI-interface-overlaps-1ps.txt', np.array(Sab_array))
